...
define("ACCOUNT_REMOVE_METADATA_HEADER_PREFIX", "X-Remove-Account-Meta-");
...
define("CONTAINER_REMOVE_METADATA_HEADER_PREFIX", "X-Remove-Container-Meta-");
...
class CF_Http
{
    ...
    #
    function authenticate($user, $pass, $host=NULL)
    {
        $path = array();
        $headers = array(
