...
class CF_Connection
{
     ...
     * $auth->authenticate();
     *
     * Create a connection to the storage system(s) and pass in the
     * validated CF_Authentication instance.
     * 
     * $conn = new CF_Connection($auth);
     * </code>
    ...
    {
        $this->cfs_http = $cfs_auth->cfs_http;
    ...
    function create_container($container_name=NULL)
    {
        ...
        if ($return_code == 401 && $this->_re_auth()) {
     ...
     * print "Number of Objects: " . $images->object_count . "\n";
